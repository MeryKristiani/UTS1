...
public class TriangleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        jenisSegitiga = view.findViewById(R.id.hasil_jenis_segitiga);
        sisi1 = view.findViewById(R.id.sisi1_segitiga);
        sisi2 = view.findViewById(R.id.sisi2_segitiga);
        alas = view.findViewById(R.id.sisi3_segitiga);
        outputPerhitungan = view.findViewById(R.id.hasil_perhitungan_segitiga);
        outputRumus = view.findViewById(R.id.hasil_rumus_segitiga);
        calculateLuas = view.findViewById(R.id.calculate_luas_segitiga);
        calculateKeliling = view.findViewById(R.id.calculate_keliling_segitiga);
